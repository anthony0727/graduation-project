...
/* This program implements the original o2 set mechanism via a B-tree */
/* It inserts integers "objects" into a b-tree */
...
*/
    ...
    e = wiss_lock_file(transId, index, l_IX,  COMMIT,  FALSE);
    CHECKERR ("build/wiss_lock_file", e);
...
*/
	...
	e = wiss_insertindex(index, &key, &rid, transId, TRUE, FALSE);
